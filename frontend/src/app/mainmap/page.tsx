...
export default function MainMapPage() {
    // ... all component state and useEffect hooks ...
    ...
    return (
        <div className="flex h-screen w-screen bg-neutral-900 text-white p-4 space-x-4">
            ...
            <div className="flex flex-col w-[70%] h-full space-y-4">
                ...
                {/* Footer */}
                {canViewRestrictedComponents(role) && <FooterControls />}
            </div>

            <div className="flex flex-col flex-1 h-full bg-neutral-800 rounded-lg p-4 overflow-y-auto">
                <h2 className="text-lg mb-2 flex-shrink-0">Current Role: {role || 'Unknown'}</h2>
